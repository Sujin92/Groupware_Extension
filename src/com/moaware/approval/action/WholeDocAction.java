...
public class WholeDocAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ApprovalDto> list = ApprovalServiceImpl.getApprovalServiceImpl().wholeList(memberDto.getEmp_num(), pg);
		request.setAttribute("wholeDoc", list);
