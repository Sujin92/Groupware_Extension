...
public class ScheduleUpdateAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		scheduleDto.setContent(request.getParameter("contenttext"));
		scheduleDto.setFreedayselector(request.getParameter("fds"));
		int cnt = ScheduleServiceImpl.getScheduleService().scheduleDto2(scheduleDto);
