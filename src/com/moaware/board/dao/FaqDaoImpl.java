...
public class FaqDaoImpl implements FaqDao {
	...
	private static FaqDao faqDaoImpl;
	
	static{
		faqDaoImpl = new FaqDaoImpl();
	}
	
	private FaqDaoImpl(){}
	
	public static FaqDao getFaqDaoImpl() {
		return faqDaoImpl;
	}
	...
	public int writeArticle(BoardDto boardDto) {
		...
		try {
			...
			StringBuffer sql = new StringBuffer();
			sql.append("insert \n");
			sql.append("	into faqboard (seq, emp_num, name, subject, content, hit, logtime) \n");
	...
	public int modifyArticle(BoardDto boardDto) {
		...
		try {
			...
			sql.append("update faqboard set subject =?, content =? \n");
			sql.append("where seq = ?");
			pstmt = conn.prepareStatement(sql.toString());
	...
	public int deleteArticle(int seq) {
		...
		try {
			...
			board_sql.append("delete faqboard where seq = ?");
