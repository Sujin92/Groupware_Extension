...
<%
	...
	List<ApprovalDto> list = (List<ApprovalDto>) request.getAttribute("returnDoc");
	if (list != null) {
		...
		<div class="col-lg-12">
			...
			<div class="col-lg-8">
				...
				<table class="table table-bordered">
					...
					%>
					<tr align="center">
						<td align="center" class="text_gray" colspan="8"><br> 반려 문서가 존재하지 않습니다.<br> <br></td>
					</tr>
					<%
						}
					%>
...
function listArticle(mpg) {
	document.commonForm.act.value = "returnDoc";
