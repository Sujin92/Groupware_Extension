uu<%@page import="com.moaware.board.model.ReboardDto"%>
...
ReboardDto boardDto = (ReboardDto) request.getAttribute("article");
if(boardDto != null) {
%>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td>
		<b>Q&A</b> &nbsp;<font style="font-size: 8pt">|</font>&nbsp; 묻고 답하기 게시판입니다.<br><br>
		</td>
		<td align="right"></td>
	</tr>
	<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		...
		<button type="button" class="btn btn-warning" onclick="javascript:moveReply('<%=boardDto.getSeq()%>');">답글</button>
<%
