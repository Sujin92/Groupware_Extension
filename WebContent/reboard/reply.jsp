...
<input type="hidden" name="pseq" value="<%=boardDto.getSeq()%>">
    <tbody>
            <tr>
                <th width="80">제목: </th>
                <td><input type="text" placeholder="제목을 입력하세요. " name="subject" class="form-control"
                value="Re:<%=boardDto.getSubject() %>"></td>
            </tr>
            <tr>
                <th width="80">내용: </th>
                <td><textarea id="content" cols="10" rows="15" placeholder="내용을 입력하세요. " name="content" class="form-control">
